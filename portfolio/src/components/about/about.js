        ...
        <section className={styles.aboutSection}>
            ...
            <div className={styles.aboutText}>
                ...
                <p>
                    ...
                    My favorite number is 2 because 1/top is easy to get and very hard to maintain. Also 2nd makes you work hard. I enjoy watching football (soccer) specially premier league <i className="far fa-futbol"></i>. And I love to play FIFA. Lastly, i love to discuss in person and solve the problem.
                </p> 
            </div>       
        </section>
        <section className={styles.strength}>
            <h1> Know My Strength & How I can assist you </h1>
            <p>How about looking more into what i have done in past few years and think how working with me be fruitfull to you. My resume is standardized to this particular area but please remember that resume doesnot explain everything about that person.</p>
